...
public class _01_DownCasting {
	...
	public static void main(String[] args) {
		...
		// 부모클래스 -> 자식클래스 변환은 자동으로 변환되지 않아서 강제 변환해야함!
		Bike b = new FourWheelBike("철수");
		b.bikeInfo();
		b.ride();
//		b.addWheel(); // 강제형변환 필요!
		// b는 FourWheelBike 객체를 가리키고 있지만, 부모 클래스 타입이 되었기 때문에 FourWheelBike의 기능인
		// addWheel을 사용할 수 없다
		
		// 강제형변환
		FourWheelBike fwb = (FourWheelBike)b;
		// 다시 자식클래스 고유의 기능인 addWheel을 사용하고 싶을 때 다운캐스팅한다.
		fwb.addWheel();
		fwb.bikeInfo();
		fwb.ride();
